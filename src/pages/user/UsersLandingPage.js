...
const services = [
  ...
  { icon: '📋', title: 'Civil Registration',      desc: 'Request birth, marriage, and death certificates from the Civil Registrar.' },
  { icon: '🏥', title: 'Health Services',          desc: 'Access municipal health programs, consultations, and medical assistance.' },
  { icon: '🤝', title: 'Social Welfare',           desc: 'MSWD programs for senior citizens, PWDs, and indigent families.' },
  { icon: '🌾', title: 'Agricultural Support',     desc: 'Livelihood programs and agricultural assistance for local farmers.' },
  { icon: '🏗️', title: 'Infrastructure Projects', desc: 'Updates on public works, road projects, and community infrastructure.' },
];
...
const contactItems = [
  { icon: '📍', label: 'Address',      val: 'Poblacion, Pagsanjan, Laguna 4008' },
  { icon: '📞', label: 'Telephone',    val: '(049) 501-0000 · (049) 501-0001' },
  { icon: '✉️', label: 'Email',        val: 'info@pagsanjan.gov.ph' },
      ...
      <section className="pub-hero">
        <div className="pub-hero-inner">
          <div className="pub-hero-text">
            <div className="pub-hero-badge">🏛️ Official Municipal Government Portal</div>
          ...
          <div className="pub-services-grid">
            {services.map((s, i) => (
              <div className="pub-service-card" key={i}>
                <div className="pub-service-icon">{s.icon}</div>
                <h4>{s.title}</h4>
                <p>{s.desc}</p>
        ...
        <div className="pub-section-inner">
          ...
          <div className="pub-about-hero">
            <div className="pub-about-hero-text">
              <div className="pub-about-hero-badge">🏛️ Pagsanjan, Laguna</div>
          ...
          <div className="pub-about-cards">
            <div className="pub-about-card2">
              <div className="pub-about-card2-icon">🎯</div>
              <h4>Vision</h4>
          ...
          <div className="pub-contact-grid">
            ...
            <div className="pub-contact-panel">
              <div className="pub-contact-panel-header">
                <div className="pub-contact-panel-icon">🏛️</div>
                <div>
              ...
              <div className="pub-contact-items">
                {contactItems.map(({ icon, label, val }) => (
                  <div className="pub-contact-item" key={label}>
                    <div className="pub-contact-icon">{icon}</div>
                    <div>
