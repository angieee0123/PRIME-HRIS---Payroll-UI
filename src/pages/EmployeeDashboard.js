    ...
    <div>
      ...
      <div className="welcome-banner" style={{ marginBottom: 24 }}>
        <div className="banner-left">
          <div className="emp-avatar" style={{ width: 46, height: 46, fontSize: 16, background: avatarColor, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 700, flexShrink: 0 }}>{initials}</div>
          <div>
            <h2 style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', margin: 0 }}>Welcome back, {person.name.split(' ')[0]}!</h2>
            <p style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.55)', margin: 0 }}>{person.position} · {person.dept} · {person.id}</p>
          </div>
        </div>
