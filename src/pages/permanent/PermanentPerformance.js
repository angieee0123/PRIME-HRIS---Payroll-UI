...
const myEvaluations = [
  { id: 'EVAL-2025-01', period: 'Jan-Jun 2025', rating: 4.8, status: 'Completed', evaluator: 'Mayor Office', completedDate: 'Jun 28, 2025', feedback: 'Excellent performance and leadership skills demonstrated.', strengths: ['Leadership', 'Communication', 'Problem Solving'], improvements: ['Time Management'] },
  { id: 'EVAL-2024-02', period: 'Jul-Dec 2024', rating: 4.7, status: 'Completed', evaluator: 'Mayor Office', completedDate: 'Dec 20, 2024', feedback: 'Consistently meets expectations with strong work ethic.', strengths: ['Teamwork', 'Reliability', 'Technical Skills'], improvements: ['Initiative'] },
  { id: 'EVAL-2024-01', period: 'Jan-Jun 2024', rating: 4.6, status: 'Completed', evaluator: 'Mayor Office', completedDate: 'Jun 25, 2024', feedback: 'Good performance with room for growth in leadership.', strengths: ['Dedication', 'Quality of Work'], improvements: ['Leadership', 'Communication'] },
  { id: 'EVAL-2023-02', period: 'Jul-Dec 2023', rating: 4.5, status: 'Completed', evaluator: 'Mayor Office', completedDate: 'Dec 18, 2023', feedback: 'Solid performance across all key areas.', strengths: ['Punctuality', 'Cooperation'], improvements: ['Technical Skills'] },
];

const performanceGoals = [
  { id: 'GOAL-001', title: 'Complete Advanced Leadership Training', category: 'Professional Development', progress: 65, target: 'Jul 15, 2025', status: 'In Progress' },
  { id: 'GOAL-002', title: 'Improve Team Collaboration Metrics', category: 'Teamwork', progress: 100, target: 'Jun 30, 2025', status: 'Achieved' },
  { id: 'GOAL-003', title: 'Reduce Processing Time by 20%', category: 'Efficiency', progress: 45, target: 'Dec 31, 2025', status: 'In Progress' },
];
  ...
  return (
    <div>
      ...
      <section className="stats-grid" style={{ marginBottom: 24 }}>
        {[
          { label: 'Latest Rating', value: latestRating.toFixed(1), sub: 'Jan-Jun 2025', accent: '#0b044d', icon: '⭐' },
          ...
          { label: 'Goals Achieved', value: completedGoals, sub: `${performanceGoals.length} total goals`, accent: '#8e1e18', icon: '🎯' },
        ].map((s, i) => (
